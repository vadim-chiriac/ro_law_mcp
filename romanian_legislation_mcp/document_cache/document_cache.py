...
class DocumentCache:
    ...
    def _get_cache_key(self, document_type: str, number: int, year: int, issuer: str) -> str:
    ...
    def get(self, document_type: str, number: int, year: int, issuer: str) -> Optional[LegislationDocument]:
        ...
        if not cache_file.exists():
            logger.debug(f"Cache miss for document: {document_type} {number}/{year} from {issuer}")
            return None
    ...
    def put(self, document: LegislationDocument, document_type: str, number: int, year: int, issuer: str) -> None:
        ...
        try:
            ...
            logger.info(f"Cached document: {document_type} {number}/{year} from {issuer}")
